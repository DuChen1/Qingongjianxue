...
<div class="container-fluid p-0 m-0 row">
    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <div class="container mt-5   row justify-content-center ">
            <!-- form表单 -->
            <form action="${pageContext.request.contextPath}/employer/saveEmployer"  class="row justify-content-center ">
                    ...
                    <div class=" row justify-content-center ">
                        <div class="  p-3 fs-5 col-10 content-back rounded-3 mt-4 mb-3">
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">编号</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm"
                                       name="employerId">
                            </div>
                            <div class="row mb-3 justify-content-center">
                            ...
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">单位名称</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm"
                                       name="employer_name">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">单位职能</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm"
                                       name="function1">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">单位地址</label>
                                <input id="address" type="text" class="col-8 border rounded-2 shadow-sm"
                                       name="address">
                            </div>
