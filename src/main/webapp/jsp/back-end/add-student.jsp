...
<div class="container-fluid p-0 m-0 row">
    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <div class="container mt-5   row justify-content-center ">
            <!-- form表单 -->
            <form action="${pageContext.request.contextPath}/student/saveStudent" method="post" class="row justify-content-center ">
                    ...
                    <div class=" row justify-content-center ">
                        <div class="  p-3 fs-5 col-10 content-back rounded-3 mt-4 mb-3">
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">学号</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="studentId">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">密码</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="password">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">姓名</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="name">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">性别</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="sex">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">年龄</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="age">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">学院</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="college">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">联系方式</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="phone">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">住址</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="address">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label  class="col-2 text-start  p-0">特长</label>
                                <input  type="text" class="col-8 border rounded-2 shadow-sm" name="speciality">
                            </div>

                            <div class="justify-content-center row mt-3">
                                <button class="btn col-3 fs-5 btn-back" type="submit">确认添加</button>
                            </div>
