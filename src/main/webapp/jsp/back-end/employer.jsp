    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <div class=" table-box col-10 container  shadow p-3 bg-body rounded">
            <table class="table  table-hover table-bordered table-striped  text-center">
                ...
                <c:forEach items="${requestScope.get('list1')}" var="emp" varStatus="index">
                <tbody>
                <tr>
                    <td>${index.index + 1}</td>
                    ...
                    <td>${emp.phone}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/employer/toAddEmployer" class="btn btn-success btn-sm">添加</a>
                        <a href="${pageContext.request.contextPath}/employer/toUpdateEmployer?id=${emp.employerId}" class="btn btn-primary btn-sm">修改</a>
                        <a href="${pageContext.request.contextPath}/employer/del/${emp.employerId}" class="btn btn-danger btn-sm">删除</a>
                    </td>
                </tr>
                </tbody>
                </c:forEach>
