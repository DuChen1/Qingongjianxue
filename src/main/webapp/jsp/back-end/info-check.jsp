...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/info-check.css">
</head>
...
<div class="container-fluid p-0 m-0 row">
    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <div class="container  bg-light   info-box">
            ...
            <div id="accordion" class="row justify-content-center ">
                <c:forEach items="${requestScope.get('list')}" var="emp" varStatus="index">
                <div class="card  col-8 ">
                    ...
                    <div id="collapse${index.index+1}" class="collapse" data-bs-parent="#accordion">
                        <div class="card-body">
                            ...
                            <p name="requirement">要求：${emp.requirement}</p>
                            <p>薪资：${emp.salary}</p>
                            <p>时间：${emp.time}</p>
                            <p>职位：${emp.position}</p>
                            <p>联系电话：${emp.phone}</p>
                            ...
                            <div class="row  justify-content-center ">
                                <a href="${pageContext.request.contextPath}/notice/adminPassMessage?id=${emp.messageId}" class="btn btn-back col-2 text-white  fs-5">
                                    审批通过
                                </a>

                                <p class="btn  col-1 text-white  fs-5"></p>
                                <a href="${pageContext.request.contextPath}/notice/adminRejectMessage?id=${emp.messageId}" class="btn btn-back col-2 text-white  fs-5 "
                ...
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <!-- form表单可能有问题 -->
                            <form action="${pageContext.request.contextPath}/notice/adminRejectMessage?id=${emp.messageId}" method="get">

                                <div class="modal-header">
                                    <h5 class="modal-title " id="staticBackdropLabel">请输入驳回原因</h5>
...
<%--                                form表单主体--%>
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" class="form-control" name="id" value="${emp.messageId}">

                                </div>

                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">返回</button>
                                    <button type="submit" class="btn btn-primary " data-bs-dismiss="modal">确认驳回</button>
                                </div>
                            </form>
