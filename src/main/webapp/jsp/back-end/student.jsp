...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/employer.css">
<%--    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/jsp/back-end/css/employer.css">--%>
</head>
...
<div class="container-fluid p-0 m-0 row">
    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <!-- 表格 -->
        <div class=" table-box col-10 container  shadow p-3 bg-body rounded">
            <table class="table  table-hover table-bordered table-striped  text-center">
                <h2 class=" fw-bold">学生信息表</h2><br>
                <thead class="fw-bold">
                <tr>
                    <td>序号</td>
                    <td>学院</td>
                ...
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/student/toAddStudent" class="btn btn-success btn-sm">添加</a>
                        <a href="${pageContext.request.contextPath}/student/toUpdateStudent?id=${emp.studentId}" class="btn btn-primary btn-sm">修改</a>
                        <a href="${pageContext.request.contextPath}/student/del/${emp.studentId}" class="btn btn-danger btn-sm">删除</a>
                    </td>
                </tr>
