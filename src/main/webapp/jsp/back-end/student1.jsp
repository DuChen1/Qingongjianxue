...
<div class="navbar-box col-3">
    <div class="pt-4 title-hover">
        ...
        <span class="text-white-50 fs-6" name="admin">管理员：长江七号</span>
    </div>
    <!-- 垂直导航 -->
    <ul class="nav  flex-column ">
        ...
        <li class="nav-item title-hover">
            <div class="">
                <a href="info-check.html" class="nav-link text-white-50 ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="currentColor"
...
<a href="#" class="navbar-brand float-end">
    <img src="img/logo1.png" class="rounded bg-light" style="width: 200px;" alt="logo">
</a>
<!-- 表格 -->
...
<c:forEach items="${requestScope.get('list')}" var="emp"
    ...
    <td>
    <a href="<%=basePath%>/student/toAddStudent" class="btn btn-success btn-sm">添加</a>
    <a href="<%=basePath%>/student/toUpdateStudent" class="btn btn-primary btn-sm">修改</a>
    <a href="<%=basePath%>/student/del/" class="btn btn-danger btn-sm">删除</a>
    </td>
    </tr>
