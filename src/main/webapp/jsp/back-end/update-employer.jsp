...
<div class="container-fluid p-0 m-0 row">
    ...
    <div class="top-back p-0 col-9 shadow">
        ...
        <div class="container mt-5   row justify-content-center ">
            <!-- form表单 -->
            <form action="${pageContext.request.contextPath}/employer/updateEmployer" method="" class="row justify-content-center ">
                    ...
                    <div class=" row justify-content-center ">
                        <div class="  p-3 fs-5 col-10 content-back rounded-3 mt-4 mb-3">
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">部门ID</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="employerId" value="${employer.employerId}">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">密码</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="password" value="${employer.password}">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">部门名称</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="employerName" value="${employer.employerName}">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">部门职能</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="function1" value="${employer.function1}">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">地址</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="address" value="${employer.address}">
                            </div>
                            <div class="row mb-3 justify-content-center">
                                <label for="StudentId" class="col-2 text-start  p-0">联系方式</label>
                                <input id="StudentId" type="text" class="col-8 border rounded-2 shadow-sm" name="phone" value="${employer.phone}">
                            </div>
