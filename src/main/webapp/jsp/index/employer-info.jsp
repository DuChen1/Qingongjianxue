        ...
        <div class="col-8 form-back ">
          <div class="row justify-content-center ">
            <div class="  p-3 fs-5 col-10 content-back rounded-3 mt-4 mb-3">
              <hr>
              <label for="studentId" class="form-label">编号</label>
              <input id="studentId" type="text" class="form-control border rounded-3 mb-2 "
                     name="studentId">

              <!-- <label for="password" class="form-label">密码</label>
              <input id="password" type="text" class="form-control border rounded-3 mb-2"
                  name="password"> -->
              <label for="name" class="form-label">单位名称</label>
              <input id="name" type="text" class="form-control border rounded-3 mb-2" name="name">



              <label for="sex" class="form-label">单位职能</label>
              <input id="sex" type="text" class="form-control border rounded-3 mb-2" name="sex">

              <label for="age" class="form-label">地址</label>
              <input id="age" type="text" class="form-control border rounded-3 mb-2" name="age">
              ...
              <div class="justify-content-center row mt-3">
                <button class="btn col-4 fs-5 btn-back">确认修改</button>
              </div>
