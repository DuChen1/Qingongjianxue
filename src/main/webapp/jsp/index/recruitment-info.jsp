...
<head>
    ...
    <link rel="stylesheet" href="./css/recruitment-hall.css">
            ...
            <div class="card bg-light col-8">
                ...
                <div id="collapseTwo" class="collapse show" data-bs-parent="#accordion">
                    <div class="card-body">
                        ...
                        <p name="studentId">学号：1202000001</p>
                        <p name="name">姓名</p>
                        <p>性别： </p>
                        <p>年龄：</p>
                        <p>学院</p>
                        ...
                        <div class="row  justify-content-center ">
                            <button class="btn btn-back col-2  fs-5">
                                聘用
                            </button>
                            <button class="btn btn-back col-2  fs-5" data-bs-toggle="modal"
                        ...
                        <form>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary text-white"
                                        data-bs-dismiss="modal">确认驳回</button>
                            </div>
                        </form>
