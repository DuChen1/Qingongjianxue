        ...
        <div id="accordion" class="row justify-content-center">
            ...
            <div class="card bg-light col-8">
                <div class=" p-2 title-back rounded border ">
                    <a href="#collapse1" class="btn fs-5 a-back col-7 " data-bs-toggle="collapse">
                        <span class="float-start">超市上架员</span>
                    </a>
                    <a href="#collapse1" class="btn fs-5 a-back col-4 " data-bs-toggle="collapse">
